  ...
  return (
    <>
      ...
      <div className={`${styles.section}`}>
        <div className="hidden 800px:flex items-center justify-between h-12.5 my-3 gap-6">
          <Link to="/">
            <img
          ...
          {/* Search */}
          <div className="flex-1 max-w-120 relative">
            <input
              type="text"
            ...
            {searchData && searchData.length > 0 ? (
              <div className="absolute top-10.5 left-0 right-0 bg-white border border-gray-100 rounded-lg z-50 overflow-hidden shadow-sm">
      ...
      {/* Desktop Nav Bar */}
      <div
        className={`${active ? "shadow-sm fixed top-0 left-0 z-10" : ""} hidden 800px:flex items-center justify-between w-full bg-[#1a1a2e] px-10 h-17.5 transition`}
      >
        <div
        ...
        >
          ...
          <div className="relative" onClick={() => setDropDown(!dropDown)}>
            <div className="hidden 1000px:flex items-center gap-2 h-9.5 px-3 bg-white/10 border border-white/15 rounded-lg cursor-pointer">
          ...
          <div className="flex items-center gap-1">
            <div
              className="relative w-9.5 h-9.5 flex items-center justify-center rounded-lg cursor-pointer hover:bg-white/10"
            ...
            <div className="w-9.5 h-9.5 flex items-center justify-center cursor-pointer">
              {isAuthenticated ? (
                <Link to="/profile">
                  <img
                    src={user?.avatar?.url}
                ...
                <Link to="/login">
                  <CgProfile size={22} color="rgba(255,255,255,0.8)" />
                </Link>
              )}
            </div>
          </div>
      ...
      {/* Mobile Header */}
      <div
        className={`${active ? "shadow-sm fixed top-0 left-0 z-10" : ""} w-full h-13.5 bg-white flex items-center justify-between px-4 800px:hidden border-b border-gray-100`}
      >
        <div
      ...
      {open && (
        ...
        >
          <div
            className="fixed top-0 left-0 w-[72%] max-w-75 h-screen bg-white z-30 flex flex-col overflow-y-auto"
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
              ...
              <div
                className="w-7 h-7 flex items-center justify-center rounded-md cursor-pointer hover:bg-gray-50"
                onClick={() => setOpen(false)}
              >
                <RxCross1 size={14} />
              </div>
