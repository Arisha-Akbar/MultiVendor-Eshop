const styles = {
  ...
  heading:
    "text-[27px] text-center md:text-start font-semibold font-Roboto pb-[20px]",
  ...
  button:
    "w-[150px] bg-amber-500 hover:bg-amber-600 transition h-12.5 my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer",
  cart_button_text: "text-[#fff] text-[16px] font-semibold",
